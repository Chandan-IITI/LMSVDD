...
for f=1:tot_fold
  ...
  ctemp = 1/(0.05*size(train_data,1));
  c_array = ctemp * [10^-3 10^-2 10^-1 1]; %%% C should be between 1/num_instances and 1 as per LIBSVM svm-train.cpp file 
